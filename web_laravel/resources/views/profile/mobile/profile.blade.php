...
@section('content')
    ...
    {{-- Top Bar --}}
    <div class="top-bar">
        <a href="#" onclick="notifyFlutterBack(); return false;">
  ...
  <div class="profile-wrapper">
    ...
    {{ $streak ?? 0 }}
        ...
        <div class="menu-buttons">
            <a href="{{ route('mobile.vocabulary.index') }}" class="menu-btn vocab">
                <i class="fa-solid fa-book"></i>
                <span>Vocabulary</span>
            </a>

            <a href="{{ route('mobile.grammar.index') }}" class="menu-btn grammar">
...
@push('scripts')
    <script>
        function notifyFlutterBack() {
            // Flutter 側で捕まえる専用URL
            window.location.href = 'flutter://back';
        }
    </script>
@endpush
